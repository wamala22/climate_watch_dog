...
class Themes_Core {
    ...
    private function _header_js() {
        $core_js = "";
            ...
            $core_js .= html::script($this->js_url . "media/js/MochiKit", true);
            $core_js .= html::script($this->js_url . "media/js/Base", true);
            $core_js .= html::script($this->js_url . "media/js/Layout", true);
            $core_js .= html::script($this->js_url . "media/js/Canvas", true);
            $core_js .= html::script($this->js_url . "media/js/SweetCanvas", true);
