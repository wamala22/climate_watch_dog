<?php
	...
	'model' => 'model',
	'no_controller' => 'Tree_Watch_Dog was not able to determine a controller to process this request: %s',
	...
	'report_bug' => '<a href="%s" id="show_bugs">Report This Issue To Tree_Watch_Dog</a>',
	'resource_not_found' => 'The requested %s, %s, could not be found',
	'stack_trace' => 'Stack Trace',
	'stats_footer' => 'Loaded in {execution_time} seconds, using {memory_usage} of memory. Generated by Tree_Watch_Dog v%s.',
	'there_can_be_only_one' => 'There can be only one instance of Tree_Watch_Dog per page request',
