        ...
        <div id="right" class="clearingfix">
            ...
            if (Kohana::config('settings.allow_reports')) {
                ...
                <div class="additional-content">         
                    <ol>
                        <li><h6>The TREE WATCH DOG is a system that aims at availing reliable data regarding deforestation and afforestation in a given region/country.</h6></li>
                        <li><h6>Report any incident that happens to a tree near you and stand a chance of being rewarded.</h6></li>
                        <li><h6>The more accurate, on spot and verifiable incidents you report, the more you increase your chances of getting a big reward from the Forestry Authorities in the country.</h6></li>
                    </ol>                   
